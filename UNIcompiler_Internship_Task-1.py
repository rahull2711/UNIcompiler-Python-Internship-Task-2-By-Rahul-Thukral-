...
#In this task we have to make a number guessing game in which we have to guess a number and whenever our guess is wrong,
#,we will be given hints to guess the nummber. Hints will be like greater or less than, multiple,divisibility, odd or even
#,composite or prime number etc.
